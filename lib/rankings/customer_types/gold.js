...
Gold.prototype = {
    ...
    /**
     * This customer type uses a binary search on a sorted on a sorted array of all average ages (from all apps) to get the closest value of the given age query param
